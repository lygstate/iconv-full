...
function DBCSCodec (codecOptions, iconv) {
  ...
  for (let table of mappingTables) {
    table.pointers.results = new Uint16Array(table.pointers.results)
    table.pointers.offsets = new Uint16Array(table.pointers.offsets)
    table.unicodes.offsets = new Uint16Array(table.unicodes.offsets)
    table.wideUnicodes.offsets = new Uint16Array(table.wideUnicodes.offsets)
  }
